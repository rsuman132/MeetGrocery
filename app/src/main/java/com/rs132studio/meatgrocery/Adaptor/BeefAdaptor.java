...
public class BeefAdaptor extends RecyclerView.Adapter<BeefAdaptor.ViewHolder>{
    Context context;
    ArrayList<ChickenCategory> beefList;
    LayoutInflater layoutInflater;
    BeefAdaptor.RecyclerViewClickListner listner;

    public BeefAdaptor (Context context, ArrayList<ChickenCategory> beefList, BeefAdaptor.RecyclerViewClickListner listner) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ChickenCategory currentChickenList = beefList.get(position);
