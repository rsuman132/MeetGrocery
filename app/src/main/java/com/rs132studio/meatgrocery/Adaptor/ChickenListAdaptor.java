...
public class ChickenListAdaptor extends RecyclerView.Adapter<ChickenListAdaptor.ViewHolder> {

    Context context;
    private ArrayList<ChickenCategory> mChickenList;
    LayoutInflater layoutInflater;
    RecyclerViewClickListner listner;

    public ChickenListAdaptor(Context context, ArrayList<ChickenCategory> mChickenList, RecyclerViewClickListner listner)
    {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ChickenCategory currentChickenList = mChickenList.get(position);
